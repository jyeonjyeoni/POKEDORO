...
export interface Friend { id: string; speciesId: number; personality: string; intimacy: number; mood: string; shiny: boolean; metAt: string; befriendedAt: string; togetherSeconds: number; inRoom: boolean; lastPetAt?: string; heldEverstone?: boolean; }
